...
My project will be hosted on GitHub, so other people can play the game for free.
...
The game will have to resolve elastic ball collisions and other physical processes. To understand the maths behind the collisions I will mainly use my knowledge from maths Mechanics 1 and 2 modules but I will also research the topic online^[https://www.gamasutra.com/view/feature/131424/pool_hall_lessons_fast_accurate_.php] ^[https://en.wikipedia.org/wiki/Elastic_collision].
