...
In-game interface will consist of the cue, which can be aimed and retracted back to make a shot. The game will also have ball indicators, which will tell the players which balls they need to pot to win the game.
