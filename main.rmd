...
Because pockets are modeled as circles, we use the same algorithm to detect collisions for both balls and pockets.
...
* The game should have a border so that the cue could be used even if the ball is in a corner.
